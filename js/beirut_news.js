...
function loadNews(){
     //$.scrollUp('#scrollUp');
    var apinyt = "http://api.nytimes.com/svc/search/v2/articlesearch.json?q=beirut&begin_date=20151112&end_date=20151171&api-key=f609f52822791f5d04549f6ac2ffc9a5:1:73530506"
...
var apiguardian = "http://content.guardianapis.com/search?api-key=n2fkptej7nzynq3cy5fjw2ab&q=beirut&from-date=2015-11-12";

$.ajax({
  type: "GET",
  url: "http://content.guardianapis.com/search?api-key=n2fkptej7nzynq3cy5fjw2ab&q=beirut&from-date=2015-11-12",
  dataType: "jsonp",
  crossDomain: true,
...
function loadGoogleNews(){
  var googledata = "";
  var params = 'v=1.0&q=beirut%2bombing&start-date=2015-11-13&end-date=2015-11-17';
  $.ajax({
            data: params,
